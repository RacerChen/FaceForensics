    ...
    for level1_dir in os.listdir(split_dataset_path):
        ...
        for level2_dir in os.listdir(cur_full_path):
            ...
            for file in os.listdir(cur_full_path):
                ...
                if level2_dir == 'training':
                    shutil.copy(cur_full_path + '/' + file, merge_dataset_path + '/training/' + tag + '/' + new_filename)
                if level2_dir == 'validation':
                    shutil.copy(cur_full_path + '/' + file, merge_dataset_path + '/validation/' + tag + '/' + new_filename)


if __name__ == '__main__':
    merge_in_one('/home/jc/Faceforensics_onServer/FaceForensics++images',
                 '/home/jc/Faceforensics_onServer/Final_Faceforensics++')
